...
describe('divide', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.divide(8.423525, 100.54354))).to.be.equal('0.0837798728789537348694903720318580388158204893');
    });
    it('2', () => {
    ...
    it('4', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.divide(2, 1.5))).to.be.equal('1.333333333333333333333333333333333333333333');
    });
    it('5', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.divide(2, '1.41666666666666666665'))).to.be.equal('1.411764705882352941193079584775086505190506');
    });
    it('6', () => {
...
describe('ln', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.ln(8))).to.be.equal('2.0794415416798359282516963643745297042265375331861173223768630983240904193677859358');
    });
    it('2', () => {
    ...
    it('3', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.ln(0.04))).to.be.equal('-3.2188758248682007492015186664523752790511655784316838838091369016759095806322140642');
    });
    it('4', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.ln(0.1))).to.be.equal('-2.30258509299404568401799144395745971490492285906510749665471812987932');
    });
    it('5', () => {
    ...
    it('6', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.ln(0.2))).to.be.equal('-1.6094379124341003746007593332261876395255642241631661618961369016759095806322140642');
    });
});
describe('exp', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.exp(0.43242))).to.be.equal('1.54098219178607389338293231610903660191996888074634962735078083746622376820410791697762485850758727547808158834932431712756588313987228217037206531991');
    });
});
describe('power', () => {
    it('1', () => {
    ...
    it('3', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.power(1.74, 3.14))).to.be.equal('5.69278313249561028952140592115895686170537103204210627476093006696236409922300389126738440542759946536851155627793357512473775');
    });
    it('4', () => {
...
describe('sqrt', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.sqrt(2))).to.be.equal('1.4142135623730950488016887242096980785696717142810821533203125');
    });
    it('2', () => {
...
describe('tan', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.tan(0.1243))).to.be.equal('0.12494414654734352405365453192949277796794');
    });
    it('2', () => {
...
describe('cot', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.cot(0.1243))).to.be.equal('8.00357621892340908314694191873854312223338');
    });
    it('2', () => {
...
describe('sec', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.sec(0.1243))).to.be.equal('1.0077752922931004536756918747324428154464');
    });
    it('2', () => {
...
describe('csc', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.csc(0.1243))).to.be.equal('8.0658063634156463351982914655668133538992');
    });
    it('2', () => {
...
describe('asin', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.asin(0.533))).to.be.equal('0.5621422382693426070971522842576262975337954080503320499385457');
    });
    it('2', () => {
...
describe('acos', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.acos(0.43223))).to.be.equal('1.12383207873275666998035755079066608037481537659971833748793077868497');
    });
    it('2', () => {
...
describe('atan', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.atan(0.1243))).to.be.equal('0.12366570450169812188959191619059270324788673471160668062023120112196937617757270759575611428884658365320873868462294');
    });
    it('2', () => {
...
describe('atan2', () => {
    ...
    it('2', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.atan2(0.1243, 2.321))).to.be.equal('1.51729293611513921404568864965737042277476147190619535661884715396272');
    });
    it('3', () => {
    ...
    it('4', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.atan2(-0.1243, 1.432))).to.be.equal('1.657380979726293965145260365216993980746274182752793127058498817593508');
    });
    it('5', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.atan2(-0.1243, -0.32))).to.be.equal('-1.941295464679711452492024830703880921997043032396204468999930621106755977204');
    });
    it('5', () => {
...
describe('acot', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.acot(0.1243))).to.be.equal('1.44713062229319849734172977544915873885069796497594622986676879887803062382242729240424388571115341634679126131537706');
    });
});
describe('asec', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.asec(1.43223))).to.be.equal('0.797899637398147512173304456358103895544011835216796115387');
...
describe('acsc', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.acsc(1.523))).to.be.equal('0.716300443472191833475772111768212952834942144649275768889');
...
describe('sinh', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.sinh(1.523))).to.be.equal('2.1839528659100170527374504125151073756727572056931542101432031896441680417253722567427926350063333948389603715680784509930635929');
    });
});
describe('cosh', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.cosh(1.523))).to.be.equal('2.40200960042140067314888632238568536553032117427630656674152346982208402086268612837139631750316669741948018578403922549653179645');
    });
});
describe('tanh', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.tanh(1.523))).to.be.equal('0.909219041225676840227934629350112661706365');
    });
});
describe('coth', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.coth(1.523))).to.be.equal('1.099844981966001809380675922203530638199648');
    });
    it('2', () => {
...
describe('sech', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.sech(1.523))).to.be.equal('0.416318069596625794179980373716427845431619');
    });
});
describe('csch', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.csch(1.523))).to.be.equal('0.457885339747621582772201107258129370328669');
    });
    it('2', () => {
...
describe('asinh', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.asinh(1.523))).to.be.equal('1.2074539771550620727031144922676934208108506906010682987550215457602430026933423687804129749516905457888901207979935689947404441501945172782533274733429');
    });
});
describe('acosh', () => {
    it('1', () => {
    ...
    it('2', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.acosh(3.132))).to.be.equal('1.808299817787071575127091121106546362781060882730228422328707933779054');
    });
    it('3', () => {
...
describe('atanh', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.atanh(-0.12))).to.be.equal('-0.1205810284084440352303206434681134989450028391184441515650626312040060807653875');
    });
    it('2', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.atanh(0.423))).to.be.equal('0.451340165790876403833794015078502530850529923606035255131651821247678594343390799024629572686087611293710359369839279256486562721');
    });
    it('3', () => {
...
describe('acoth', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.acoth(-1.12))).to.be.equal('-1.43583981244200607137461195105326603285624368286187368502199536128587604243299378730437658607');
    });
    it('2', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.acoth(1.423))).to.be.equal('0.872694770885123881197980091442851219085524823142538054461722578320221380175758350739289843');
    });
    it('3', () => {
...
describe('asech', () => {
    ...
    it('2', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.asech(0.543))).to.be.equal('1.220266245966049346089984984498300908621782354208342794286783547992007187167712820788245893253133133032339278737719414082423472');
    });
    it('3', () => {
...
describe('acsch', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.acsch(-1.12))).to.be.equal('-0.803548254845450791307512359709610144594236146263149955326626138350106758417690851559836042899');
    });
    it('2', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.acsch(1.423))).to.be.equal('0.65491038024859147045714403478325217264921474059191977968513408834423816352632913519880766');
    });
});
describe('AGM', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.AGM(12, 6))).to.be.equal('8.7407461862814412151185942995904918498431707731706552207469940185546875');
    });
    it('2', () => {
...
describe('K', () => {
    it('1', () => {
        chai_1.expect(index_1.default.stringify(index_1.default.K(0.32))).to.be.equal('1.6135037415649716545922387873211206083943');
    });
    it('2', () => {
...
describe('Comparison', () => {
    ...
    it('7', () => {
        ...
        chai_1.expect(index_1.default.eq(-2, 5)).to.be.false;
        chai_1.expect(index_1.default.eq(0.2, 1)).to.be.false;
    });
    it('8', () => {
        chai_1.expect(index_1.default.neq(5, 5)).to.be.false;
        chai_1.expect(index_1.default.neq(2, 5)).to.be.true;
        chai_1.expect(index_1.default.neq(-2, 5)).to.be.true;
        chai_1.expect(index_1.default.neq(2, 0.5)).to.be.true;
    });
});
describe('Rounding', () => {
    it('1', () => {
