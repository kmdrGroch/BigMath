...
describe('divide', () => {
  it('1', () => {
    expect(BigMath.stringify(BigMath.divide(8.423525, 100.54354))).to.be.equal('0.08377987287895373486949037203185803881582');
  });
  it('2', () => {
  ...
  it('4', () => {
    expect(BigMath.stringify(BigMath.divide(2, 1.5))).to.be.equal('1.3333333333333333333333333333333333333333');
  });
  it('5', () => {
    expect(BigMath.stringify(BigMath.divide(2, '1.41666666666666666665'))).to.be.equal('1.4117647058823529411930795847750865051905');
  });
});

describe('ln', () => {
  it('1', () => {
    expect(BigMath.stringify(BigMath.ln(8))).to.be.equal('2.0794415416798359282516963643745297042265397901929500114378491728346877242848862');
  });
});

describe('exp', () => {
  it('1', () => {
    expect(BigMath.stringify(BigMath.exp(0.43242))).to.be.equal('1.54098219178607389338293231610903660191996907395949397751810090996714634384071234040050003579243116452471074325714198461');
  });
});
...
describe('sqrt', () => {
  it('1', () => {
    expect(BigMath.stringify(BigMath.sqrt(2))).to.be.equal('1.41421356237309504880168872420969807856963333301544189453125');
  });
});
...
describe('sinh', () => {
  it('1', () => {
    expect(BigMath.stringify(BigMath.sinh(1.523))).to.be.equal('2.1839528659100170527374504125151073756727');
  });
});

describe('asinh', () => {
  it('1', () => {
    expect(BigMath.stringify(BigMath.asinh(1.523))).to.be.equal('1.207453977155088198078061994822606339279278262743314776033');
  });
});
